...
int main()
{
  ...
  assert(boost::xpressive::regex_match(std::string("1234 AB"),dutch_zip_code)==true);
  assert(boost::xpressive::regex_match(std::string("1234 ab"),dutch_zip_code)==false);
  assert(boost::xpressive::regex_match(std::string("1234ab"),dutch_zip_code)==false);
  ...
  assert(boost::xpressive::regex_match(s,dutch_zip_code)==false
    && "the std::string does not match a dutch zip code");
  assert(boost::xpressive::regex_search(s,dutch_zip_code)==true
