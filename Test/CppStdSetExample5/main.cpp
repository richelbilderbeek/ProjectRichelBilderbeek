...
int main()
{
  //Put MyClass instances in std::vector
  std::vector<boost::shared_ptr<MyClass>> v;
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("five",5)));
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("four",4)));
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("one",1)));
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("six",6)));
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("three",3)));
  v.push_back(boost::shared_ptr<MyClass>(new MyClass("two",2)));
  ...
  //Copy from std::vector to std::map
