...
struct Dialog
{
  ...
  */
  ...
  std::string Get3dMesh() const noexcept { return m_3dmesh_output_ply; }
  ...
  Shapes GetShapes() const noexcept { return m_shapes; }
  ...
  std::string GetTriangleInput() const noexcept { return m_triangle_input_poly; }
  ///TriangleMesh is the 2D mesh generated by Triangle
  Shapes GetTriangleMesh() const noexcept { return m_triangle_shapes; }
  ///TriangleMesh is the 2D mesh generated by Triangle
  ...
  std::string GetTriangleOutputEle() const noexcept { return m_triangle_output_ele; }
  ///Obtain the content of the .node file that Triangle wrote part of its output to
  std::string GetTriangleOutputNode() const noexcept { return m_triangle_output_node; }
  ///Obtain the content of the .poly file that Triangle wrote part of its output to
  std::string GetTriangleOutputPoly() const noexcept { return m_triangle_output_poly; }
