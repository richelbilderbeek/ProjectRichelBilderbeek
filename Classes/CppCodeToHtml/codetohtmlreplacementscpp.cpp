...
const std::vector<std::pair<std::string,std::string> > c2h::Content::CreateCppReplacements()
{
  ...
  //18
    ...
    { "std::bad_exception","<a href=\"CppB$ad_e$xception.htm\">s$td::b$ad_e$xception</a>" },
  ...
  //14
    ...
    { "std::exception","<a href=\"C$ppS$tdE$xception.htm\">st$d::ex$ception</a>" },
    ...
    { "std::make_pair","<a href=\"C$pp$Make_p$air.htm\">s$td::ma$ke_pair</a>" },
  ...
  //9
    ...
    { "Exception","<a href=\"CppE$xception.htm\">Ex$ception</a>" },
