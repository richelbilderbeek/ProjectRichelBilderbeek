...
const std::vector<std::pair<std::string,std::string> > ribi::c2h::Replacer::CreateCppReplacements() noexcept
{
  ...
  {  
    ...
    { "boost::timer::auto_cpu_timer","<a href=\"CppBoostAuto_cpu_timer.htm\">b$oost::timer::auto_cpu_timer</a>" },
    ...
    { "std::chrono::system_clock","<a href=\"C$ppS$ystem_c$l$ock.htm\">s$td::c$hrono::s$ystem_c$l$ock</a>" },
    { "std::chrono::high_resolution_clock","<a href=\"C$ppH$igh_r$esolution_c$l$ock.htm\">s$td::c$hrono::h$igh_r$esolution_c$l$ock</a>" },
...
//    { "ThresholdFiltererVcl","<a href=\"T$oolT$hresholdF$iltererV$cl.htm\">T$hresholdF$iltererV$cl</a>" },
  ...
  //18
    ...
    { "std::adjacent_find","<a href=\"CppA$djacent_find.htm\">s$td::ad$jacent_fi$nd</a>" },
    { "std::back_inserter","<a href=\"CppB$ack_inserter.htm\">s$td::back_ins$erter</a>" },
    { "std::bad_exception","<a href=\"CppB$ad_e$xception.htm\">s$td::b$ad_e$xcept$ion</a>" },
    { "std::binary_search","<a href=\"CppB$inary_search.htm\">st$d::binary_search</a>" },
    { "std::copy_backward","<a href=\"CppC$opy_b$ackward.htm\">st$d::c$opy_b$ackward</a>" },
    { "std::find_first_of","<a href=\"CppF$ind_first_of.htm\">s$td::fi$nd_first_of</a>" },
    { "std::greater_equal","<a href=\"CppG$reater_equal.htm\">st$d::gre$ater_equal</a>" },
    { "std::hash_multimap","<a href=\"CppH$ash_multimap.htm\">st$d::hash_multimap</a>" },
    { "std::hash_multiset","<a href=\"CppH$ash_multiset.htm\">st$d::hash_multiset</a>" },
    { "std::inner_product","<a href=\"CppI$nner_product.htm\">st$d::i$nner_product</a>" },
    { "std::inplace_merge","<a href=\"CppI$nplace_merge.htm\">st$d::inplace_merge</a>" },
    { "std::is_heap_until","<a href=\"CppI$s_h$eap_u$ntil.htm\">s$td::i$s_h$eap_u$ntil</a>" },
    { "std::istringstream","<a href=\"CppI$stringstream.htm\">s$td::ist$ringstream</a>" },
    { "std::move_backward","<a href=\"CppM$o$ve_b$ackward.htm\">s$td::mo$ve_b$ackward</a>" },
    { "std::ostringstream","<a href=\"CppO$stringstream.htm\">s$td::ost$ringstream</a>" },
    ...
    { "std::unordered_map","<a href=\"CppU$nordered_m$ap.htm\">s$td::u$no$rdered_m$ap</a>" },
  ...
  //17
    ...
    { "std::domain_error","<a href=\"CppD$oma$in_error.htm\">st$d::d$oma$in_e$rror</a>" },
    { "std::forward_list","<a href=\"C$ppF$orward_l$ist.htm\">s$td::f$orward_l$ist</a>" },
  ...
  //14
    ...
    { "std::make_pair","<a href=\"C$pp$M$ake_p$air.htm\">s$td::ma$ke_pair</a>" },
    { "std::mbsrtowcs","<a href=\"CppM$bsrtowcs.htm\">st$d::mbsrtowcs</a>" },
    { "std::multi_map","<a href=\"C$pp$Multi_m$ap.htm\">s$td::m$ulti_map</a>" },
    { "std::noshowpos","<a href=\"C$pp$Noshowpos.htm\">s$td::n$os$howp$os</a>" },
    { "std::once_flag","<a href=\"C$pp$Once_f$lag.htm\">s$td::o$nce_f$lag</a>" },
    { "std::partition","<a href=\"CppP$artition.htm\">st$d::partition</a>" },
    { "std::push_heap","<a href=\"CppP$ush_heap.htm\">st$d::push_heap</a>" },
    { "std::remove_if","<a href=\"CppR$emove_i$f.htm\">st$d::remove_i$f</a>" },
    { "std::set_union","<a href=\"CppS$et_un$ion.htm\">st$d::set_uni$on</a>" },
    { "std::setlocale","<a href=\"CppS$etlocale.htm\">st$d::setlocale</a>" },
    { "std::showpoint","<a href=\"CppS$howpoi$nt.htm\">st$d::showpoi$nt</a>" },
    ...
    { "std::uppercase","<a href=\"CppU$pperca$se.htm\">st$d::u$pperca$se</a>" },
    { "std::vswprintf","<a href=\"CppV$swprin$tf.htm\">st$d::vswpri$ntf</a>" },
  ...
  //13  
    ...
    { "boost::signal","<a href=\"B$oostS$ignal.htm\">b$oost::si$gnal</a>" },
    ...
    { "std::auto_ptr","<a href=\"CppA$u$to_ptr.htm\">s$td::aut$o_p$tr</a>" },
    { "std::bad_cast","<a href=\"CppB$ad_cast.htm\">st$d::b$ad_c$ast</a>" },
    { "std::clearerr","<a href=\"CppC$learerr.htm\">st$d::c$leare$rr</a>" },
    { "std::count_if","<a href=\"CppC$o$unt_i$f.htm\">s$td:$:co$unt_i$f</a>" },
    { "std::difftime","<a href=\"CppD$i$f$ft$ime.htm\">st$d::di$fft$ime</a>" },
    { "std::distance","<a href=\"CppD$istance.htm\">st$d::di$stance</a>" },
    { "std::equal_to","<a href=\"CppE$qual_to.htm\">st$d::eq$ual_to</a>" },
    { "std::find_end","<a href=\"CppF$ind_e$nd.htm\">s$td::fi$nd_e$nd</a>" },
    { "std::for_each","<a href=\"CppF$or_each.htm\">s$td:$:fo$r_each</a>" },
    { "std::fwprintf","<a href=\"CppF$wpri$ntf.htm\">st$d::f$wpri$ntf</a>" },
    { "std::generate","<a href=\"CppG$enerate.htm\">st$d::g$enerate</a>" },
    { "std::getwchar","<a href=\"CppG$etwch$ar.htm\">st$d::g$etwch$ar</a>" },
    { "std::hash_map","<a href=\"CppH$ash_m$ap.htm\">st$d::h$ash_m$ap</a>" },
    { "std::hash_set","<a href=\"CppH$ash_s$et.htm\">st$d::h$ash_s$et</a>" },
    { "std::ifstream","<a href=\"CppI$fs$tream.htm\">st$d::i$fs$tream</a>" },
    { "std::includes","<a href=\"CppI$ncludes.htm\">st$d::includes</a>" },
    { "std::internal","<a href=\"CppI$$nternal.htm\">st$d::i$nternal</a>" },
    { "std::iswalnum","<a href=\"CppI$swalnum.htm\">st$d::i$swalnum</a>" },
    { "std::iswalpha","<a href=\"CppI$swalpha.htm\">st$d::i$swalpha</a>" },
    { "std::iswcntrl","<a href=\"CppI$swcntrl.htm\">st$d::i$swcntrl</a>" },
    { "std::iswctype","<a href=\"CppI$swctype.htm\">st$d::i$swctype</a>" },
    { "std::iswdigit","<a href=\"CppI$swdigit.htm\">st$d::i$swdigit</a>" },
    { "std::iswgraph","<a href=\"CppI$swg$raph.htm\">st$d::i$swgraph</a>" },
    { "std::iswlower","<a href=\"CppI$swl$ower.htm\">st$d::i$swlower</a>" },
    { "std::iswpunct","<a href=\"CppI$swpunct.htm\">st$d::i$swpunct</a>" },
    { "std::iswspace","<a href=\"CppI$swspace.htm\">st$d::i$swspace</a>" },
    { "std::iswupper","<a href=\"CppI$swu$pper.htm\">st$d::i$swu$pper</a>" },
    { "std::isxdigit","<a href=\"CppI$sxdigit.htm\">st$d::i$sxd$igit</a>" },
    { "std::mbstowcs","<a href=\"CppM$bstowcs.htm\">st$d::m$bstowcs</a>" },
    { "std::mismatch","<a href=\"CppM$ismatch.htm\">st$d::m$ism$atch</a>" },
    { "std::multimap","<a href=\"CppM$ultim$ap.htm\">st$d::m$ultim$ap</a>" },
    { "std::multiset","<a href=\"CppM$ultis$et.htm\">st$d::m$ultis$et</a>" },
    { "std::noskipws","<a href=\"CppN$oskipws.htm\">st$d::n$os$kipws</a>" },
    { "std::ofstream","<a href=\"CppO$fs$tream.htm\">st$d::o$fs$tream</a>" },
    { "std::pop_heap","<a href=\"CppP$op_h$eap.htm\">st$d::p$op_h$eap</a>" },
    { "std::putwchar","<a href=\"CppP$utwch$ar.htm\">st$d::p$utwch$ar</a>" },
    { "std::search_n","<a href=\"CppS$earch_n.htm\">st$d::s$earch_n</a>" },
    { "std::showbase","<a href=\"CppS$howbase.htm\">st$d::s$howb$ase</a>" },
    { "std::strerror","<a href=\"CppS$tre$rror.htm\">st$d::s$tre$rror</a>" },
    { "std::strftime","<a href=\"CppS$trft$ime.htm\">st$d::s$trft$ime</a>" },
    { "std::swprintf","<a href=\"CppS$wpri$ntf.htm\">st$d::s$wpri$ntf</a>" },
    { "std::towlower","<a href=\"CppT$owl$ower.htm\">st$d::t$owl$ower</a>" },
    { "std::towupper","<a href=\"CppT$owu$pper.htm\">st$d::t$owu$pper</a>" },
    { "std::valarray","<a href=\"CppV$ala$rray.htm\">st$d::v$ala$rray</a>" },
    { "std::vfprintf","<a href=\"CppV$fpri$ntf.htm\">st$d::v$fpri$ntf</a>" },
    { "std::vfwprint","<a href=\"CppV$fwpri$nt.htm\">st$d::v$fwpri$nt</a>" },
    { "std::vsprintf","<a href=\"CppV$spri$ntf.htm\">st$d::v$spri$ntf</a>" },
    { "std::wcsrtomb","<a href=\"CppW$csrtomb.htm\">s$td::wc$srtomb</a>" },
    { "std::wcstombs","<a href=\"CppW$cstombs.htm\">s$td::wc$stombs</a>" },
    { "std::weak_ptr","<a href=\"CppW$eak_p$tr.htm\">s$td::w$eak_p$tr</a>" },
  ...
  //12
    ...
    { "std::is_same","<a href=\"CppI$s_s$ame.htm\">s$td::i$s_s$ame</a>" },
