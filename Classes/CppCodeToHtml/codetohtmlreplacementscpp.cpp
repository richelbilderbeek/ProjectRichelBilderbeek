...
const std::vector<std::pair<std::string,std::string> > ribi::c2h::Replacer::CreateCppReplacements() noexcept
{
  ...
  {  
    ...
    { "boost::timer::auto_cpu_timer","<a href=\"CppB$oostAuto_cpu_timer.htm\">b$oost::timer::auto_cpu_timer</a>" },
    { "std::lexicographical_compare","<a href=\"CppS$tdL$exicographical_c$ompare.htm\">st$d::lexicographical_compare</a>" },
