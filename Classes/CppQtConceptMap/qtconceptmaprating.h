...
struct Rating
{
  ...
  ///Calculate a suggested complexity
  static int SuggestComplexity(const boost::shared_ptr<const ConceptMap> m_sub_conceptmap);

  ///Calculate a suggested concreteness
  static int SuggestConcreteness(const int n_examples);

  ///Calculate a suggested concreteness
  static int SuggestConcreteness(const boost::shared_ptr<const ConceptMap> m_sub_conceptmap);

  ///Calculate a suggested specificity
  static int SuggestSpecificity(const int n_examples);

  ///Calculate a suggested specificity
  static int SuggestSpecificity(const boost::shared_ptr<const ConceptMap> m_sub_conceptmap);
};
