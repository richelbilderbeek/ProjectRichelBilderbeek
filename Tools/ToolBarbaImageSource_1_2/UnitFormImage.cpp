...
void TFormImage::SetAllEnabled()
{
  ...
  ItemConvertToGrey->Enabled = true;
  ItemEnhanceContrast->Enabled = true;
  ItemHistogramEqualization->Enabled = true;
  ItemThresholdFilterColor->Enabled = true;
  ItemThresholdFilterNoColor->Enabled = true;
  */
  Image->Visible = true;
}
//---------------------------------------------------------------------------
void TFormImage::SetAllDisabled()
{
  ...
  ItemConvertToGrey->Enabled = false;
  ItemEnhanceContrast->Enabled = false;
  ItemHistogramEqualization->Enabled = false;
  ItemThresholdFilterColor->Enabled = false;
  ItemThresholdFilterNoColor->Enabled = false;
  */
