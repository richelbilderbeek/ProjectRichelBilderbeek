...
#include "UnitFormYamahaMG16_6Fx.h"
...
#pragma resource "*.dfm"
TFormYamahaMg16_6Fx *FormYamahaMg16_6Fx;
//---------------------------------------------------------------------------
__fastcall TFormYamahaMg16_6Fx::TFormYamahaMg16_6Fx(TComponent* Owner,
...
//---------------------------------------------------------------------------
void TFormYamahaMg16_6Fx::UpdateBuffer()
{
  switch (mDisplayMode)
  {
    case modeView:
...
//---------------------------------------------------------------------------
void TFormYamahaMg16_6Fx::OnMouseDown(const int x, const int y)
{
  switch (mDisplayMode)
  {
    case modeView:
...
//---------------------------------------------------------------------------
void TFormYamahaMg16_6Fx::OnAfterResize()
{
  //Use
  {
