...
#pragma resource "*.dfm"
TFormAmplifier *FormAmplifier;
//---------------------------------------------------------------------------
__fastcall TFormAmplifier::TFormAmplifier(TComponent* Owner,
...
//---------------------------------------------------------------------------
void TFormAmplifier::UpdateBuffer()
{
  switch (mDisplayMode)
  {
    case modeView:
...
//---------------------------------------------------------------------------
void __fastcall TFormAmplifier::TimerTickTimer(TObject *Sender)
{
  mCdPlayer->Tick(); //Important for recording and playing
