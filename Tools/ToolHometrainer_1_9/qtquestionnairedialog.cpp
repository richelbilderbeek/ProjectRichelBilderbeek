...
#include "ui_qtquestionnairedialog.h"
//---------------------------------------------------------------------------
QtQuestionnaireDialog::QtQuestionnaireDialog(QWidget *parent) :
  QDialog(parent),
  ui(new Ui::QtQuestionnaireDialog)
{
  ui->setupUi(this);
}
//---------------------------------------------------------------------------
QtQuestionnaireDialog::~QtQuestionnaireDialog()
{
  delete ui;
}
//---------------------------------------------------------------------------
