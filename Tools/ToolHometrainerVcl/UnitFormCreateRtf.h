...
//---------------------------------------------------------------------------
#ifndef UnitFormCreateRtfH
#define UnitFormCreateRtfH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <string>
//---------------------------------------------------------------------------
class TFormCreateRtf : public TForm
{
...
public:		// User declarations
        __fastcall TFormCreateRtf(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormCreateRtf *FormCreateRtf;
//---------------------------------------------------------------------------
