...
const std::string ribi::QtMultiScaleChordRelationsWidget::GetVersion() noexcept
{
  return "1.1";
}

const std::vector<std::string> ribi::QtMultiScaleChordRelationsWidget::GetVersionHistory() noexcept
{
