...
const std::vector<std::string> KalmanFiltererMenuDialog::GetVersionHistory()
{
  ...
  v.push_back("2013-07-17: version 1.15: allow copying from and pasting to parameter tables, transitioned to Qt5, GCC 4.8.0 and Boost 1.54.0, able to crosscompile again");
  return v;
}
