...
//---------------------------------------------------------------------------
#ifndef WTTESTDIALMENUDIALOG_H
#define WTTESTDIALMENUDIALOG_H
...
struct WtTestDialMenuDialog : public Wt::WContainerWidget
{
  WtTestDialMenuDialog();
  private:
