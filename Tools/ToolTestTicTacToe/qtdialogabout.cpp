...
#include "qtdialogwhatsnew.h"
#include "ui_qtdialogabout.h"
    ...
    ui(new Ui::DialogAbout)
{
  ...
  ui->label_tictactoewidget_version->setText(
    QString("QtTicTacToeWidget version: ")
    + QString(QtTicTacToeWidget::GetVersion().c_str()));
