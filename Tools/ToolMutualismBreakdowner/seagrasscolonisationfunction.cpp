...
SeagrassColonisationFunction::SeagrassColonisationFunction()
{
  #ifndef NDEBUG
  Test();
  #endif
...
#ifndef NDEBUG
void SeagrassColonisationFunction::Test() noexcept
{
  {
...
SeagrassInvertedExponential::SeagrassInvertedExponential(
    const double alpha,
...
std::string SeagrassInvertedExponential::ToStr() const noexcept
{
  std::stringstream s;
  s
