...
SeagrassStressedLogisticGrowth::SeagrassStressedLogisticGrowth(
...
SeagrassStressedLogisticGrowth::Growth
  SeagrassStressedLogisticGrowth::CalculateGrowth(
...
std::string SeagrassStressedLogisticGrowth::ToStr() const noexcept
{
  std::stringstream s;
  s
