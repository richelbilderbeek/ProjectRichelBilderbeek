...
void SulfideDetoxificationFunction::Test() noexcept
{
  {
...
SulfideDetoxificationFunction::Change
  LinearSulfideDetoxification::CalculateDetoxification(
...
std::string LinearSulfideDetoxification::ToStr() const noexcept
{
  std::stringstream s;
  s
