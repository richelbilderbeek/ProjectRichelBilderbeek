...
std::vector<std::string> ribi::QtPicToCodeMainDialog::PicToNdsCode(const QImage& image) const
{
...
std::vector<std::string> ribi::QtPicToCodeMainDialog::PicToQtCode(const QImage& qt_image) const
{
  return PicToCodeMainDialog().PicToQtCode(ImageToImage(qt_image));
}
