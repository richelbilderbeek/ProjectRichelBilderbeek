...
ribi::p2c::PicToCodeMainDialog::PicToCodeMainDialog()
...
void ribi::p2c::PicToCodeMainDialog::SetInputFile(const std::string& filename)
{
  m_image = ImageToImage(QImage(filename.c_str()));
}

void ribi::p2c::PicToCodeMainDialog::SetInputImage(const QImage& qimage)
{
...
#ifndef NDEBUG
void ribi::p2c::PicToCodeMainDialog::Test() noexcept
{
  {
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToHeaderFile() const
{
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToImplementationFile() const
{
  switch (m_graphics_library)
  {
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToNdsHeaderFile() const
{
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToNdsImplementationFile() const
{
  const int width  = std::min(256,m_image.width());
  const int height = std::min(192,m_image.height());
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToQtHeaderFile() const
{
...
std::vector<std::string> ribi::p2c::PicToCodeMainDialog::ToQtImplementationFile() const
{
  const int width  = m_image.width();
  const int height = m_image.height();
