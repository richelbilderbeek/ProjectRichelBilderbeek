...
ribi::About ribi::RandomCodeMenuDialog::GetAbout() noexcept
{
  About a(
    "Richel Bilderbeek",
    "RandomCode",
...
const std::string ribi::RandomCodeMenuDialog::GetVersion() noexcept
{
  return "4.2";
}

const std::vector<std::string> ribi::RandomCodeMenuDialog::GetVersionHistory() noexcept
{
