...
**
** Created: Mon 10. Jun 09:24:44 2013
...
static const char qt_meta_stringdata_QtKalmanFilterExperimentDialog[] = {
    ...
    "SetExample(boost::shared_ptr<KalmanFilterExample>)\0"
    "new_type\0SetKalmanFilterType(KalmanFilterType)\0"
    "arg1\0on_box_n_timesteps_valueChanged(int)\0"
...
void QtKalmanFilterExperimentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_box_n_timesteps_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_button_save_clicked(); break;
        case 4: _t->on_button_load_clicked(); break;
        case 5: _t->on_button_add_state_clicked(); break;
        case 6: _t->on_button_remove_state_clicked(); break;
        default: ;
        }
    }
}
