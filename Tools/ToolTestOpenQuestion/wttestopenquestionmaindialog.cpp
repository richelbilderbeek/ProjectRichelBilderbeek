...
ribi::WtTestOpenQuestionMainDialog::Ui::Ui()
...
ribi::WtTestOpenQuestionMainDialog::WtTestOpenQuestionMainDialog()
{
  ...
  ui.m_edit->enterPressed().connect(this,&ribi::WtTestOpenQuestionMainDialog::OnEditChanged);
  ui.m_edit->keyWentUp().connect(this,&ribi::WtTestOpenQuestionMainDialog::OnEditChanged);
  ui.m_edit->setText("-,Is this a multiple choice question?,yes,no,do not know");
  OnEditChanged();
}

void ribi::WtTestOpenQuestionMainDialog::OnEditChanged()
{
  ...
  {
    //Test
    boost::shared_ptr<WtOpenQuestionDialog> tmp(new WtOpenQuestionDialog(s));
    //Add
    ui.m_box->clear();
