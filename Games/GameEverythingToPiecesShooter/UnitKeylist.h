...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>ProjectRichelBilderbeek/Games/GameEverythingToPiecesShooter/UnitKeylist.h at develop · richelbilderbeek/ProjectRichelBilderbeek · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="59BC19D3:4E88:10A338D:523FFC0A" name="octolytics-dimension-request_id" />
...
<meta content="JQM6xwVmhImc1mGv6Rq6C3yhy3/pKlQTUyHq7BYoXv8=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-2c867c2081830b4a942703b9d3d565bf90f6046d.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="b5479068af2118811ca4dcd8c0c29e66">
        ...
        <link data-pjax-transient rel='permalink' href='/richelbilderbeek/ProjectRichelBilderbeek/blob/255fabeeb493ad41e1aa95597700a09d19eb3ff3/Games/GameEverythingToPiecesShooter/UnitKeylist.h'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Frichelbilderbeek%2FProjectRichelBilderbeek%2Fblob%2Fdevelop%2FGames%2FGameEverythingToPiecesShooter%2FUnitKeylist.h">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:2ed18415257676f08c80814a33f90bfb -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:2ed18415257676f08c80814a33f90bfb -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/richelbilderbeek/ProjectRichelBilderbeek/blob/develop/Games/GameEverythingToPiecesShooter/UnitKeylist.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="develop" data-skip-pjax="true" rel="nofollow" title="develop">develop</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/richelbilderbeek/ProjectRichelBilderbeek/blob/master/Games/GameEverythingToPiecesShooter/UnitKeylist.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
        </div>
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/richelbilderbeek/ProjectRichelBilderbeek/raw/develop/Games/GameEverythingToPiecesShooter/UnitKeylist.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/richelbilderbeek/ProjectRichelBilderbeek/blame/develop/Games/GameEverythingToPiecesShooter/UnitKeylist.h" class="button minibutton ">Blame</a>
          <a href="/richelbilderbeek/ProjectRichelBilderbeek/commits/develop/Games/GameEverythingToPiecesShooter/UnitKeylist.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L18" rel="#L18">18</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">//---------------------------------------------------------------------------</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="cp">#ifndef UnitKeylistH</span></div><div class='line' id='LC4'><span class="cp">#define UnitKeylistH</span></div><div class='line' id='LC5'><span class="c1">//---------------------------------------------------------------------------</span></div><div class='line' id='LC6'><span class="cp">#include &lt;set&gt;</span></div><div class='line' id='LC7'><span class="cp">#include &lt;vector&gt;</span></div><div class='line' id='LC8'><span class="cp">#include &quot;UnitEnums.h&quot;</span></div><div class='line' id='LC9'><span class="c1">//---------------------------------------------------------------------------</span></div><div class='line' id='LC10'><span class="k">struct</span> <span class="n">KeyList</span></div><div class='line' id='LC11'><span class="p">{</span></div><div class='line' id='LC12'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">AddKey</span><span class="p">(</span><span class="k">const</span> <span class="n">EnumKey</span><span class="o">&amp;</span> <span class="n">key</span><span class="p">);</span></div><div class='line' id='LC13'>&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">RemoveKey</span><span class="p">(</span><span class="k">const</span> <span class="n">EnumKey</span><span class="o">&amp;</span> <span class="n">key</span><span class="p">);</span></div><div class='line' id='LC14'>&nbsp;&nbsp;<span class="n">std</span><span class="o">::</span><span class="n">vector</span><span class="o">&lt;</span><span class="n">EnumKey</span><span class="o">&gt;</span> <span class="n">GetKeys</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC15'>&nbsp;&nbsp;<span class="nl">private:</span></div><div class='line' id='LC16'>&nbsp;&nbsp;<span class="n">std</span><span class="o">::</span><span class="n">set</span><span class="o">&lt;</span><span class="n">EnumKey</span><span class="o">&gt;</span> <span class="n">mSet</span><span class="p">;</span></div><div class='line' id='LC17'><span class="p">};</span></div><div class='line' id='LC18'><span class="cp">#endif</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.03998s from github-fe111-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
