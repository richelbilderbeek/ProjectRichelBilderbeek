...
struct PlayerState
{
  ...
  const QPixmap * const GetSprite() const { return m_sprite; }
...
struct PlayerJump : public PlayerState
{
  ...
  private:
  const QPixmap * const m_jump_left;
  const QPixmap * const m_jump_right;
};
...
struct PlayerLeft : public PlayerState
{
  ...
  private:
  const QPixmap * const m_walk_left_1;
  const QPixmap * const m_walk_left_2;
...
struct PlayerRight : public PlayerState
{
  ...
  private:
  const QPixmap * const m_walk_right_1;
  const QPixmap * const m_walk_right_2;
...
struct PlayerStand : public PlayerState
{
  ...
  const QPixmap * const m_stand_left;
  const QPixmap * const m_stand_right;
};
