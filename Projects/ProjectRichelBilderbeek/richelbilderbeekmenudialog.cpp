...
const std::vector<std::string> ribi::RichelBilderbeek::MenuDialog::GetVersionHistory() noexcept
{
  return {
    ...
    "2013-xx-xx: Version 1.11: added DotMatrix, Encranger, GrayCoder, MultiEncranger, PrimeExpert, QuadraticSolver, TestCanvas, TestMultipleChoiceQuestion, TestOpenQuestion"
  };
}
