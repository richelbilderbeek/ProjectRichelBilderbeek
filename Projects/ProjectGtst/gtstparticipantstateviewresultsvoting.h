...
#ifndef PROJECTGTSTPARTICIPANTSTATEVIEWRESULTSVOTING_H
#define PROJECTGTSTPARTICIPANTSTATEVIEWRESULTSVOTING_H
  ...
  : public ParticipantState, StateViewResultsVoting
{
  ...
  ParticipantStateViewResultsVoting(Participant * const participant,Server * const server);
  ...
  virtual ~ParticipantStateViewResultsVoting() {}
  ///Only let a smart pointer delete this ParticipantState
