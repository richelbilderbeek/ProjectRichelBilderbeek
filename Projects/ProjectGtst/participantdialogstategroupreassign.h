...
//---------------------------------------------------------------------------
#ifndef PARTICIPANTDIALOGSTATEGROUPREASSIGN_H
#define PARTICIPANTDIALOGSTATEGROUPREASSIGN_H
//---------------------------------------------------------------------------
...
///
///ParticipantDialogStateGroupReAssign is the state the ParticipantDialog
...
struct ParticipantDialogStateGroupReAssign
  : public ParticipantDialogState, StateGroupReAssign
{
  ///Create every ParticipantDialogState with a pointer to
  ///its ParticipantDialog
  ParticipantDialogStateGroupReAssign(
  ...
  private:
  ///Only allow a Boost smart pointer to delete ParticipantDialogStateGroupReAssign
  ...
  friend void boost::checked_delete<>(ParticipantDialogStateGroupReAssign*);

  ///The user interface
  struct Ui
  {
    Ui() : m_label_status(0), m_label_time_left(0) {}
...
#endif // PARTICIPANTDIALOGSTATEGROUPREASSIGN_H
