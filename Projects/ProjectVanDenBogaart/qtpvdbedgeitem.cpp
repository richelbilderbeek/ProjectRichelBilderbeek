    ...
    m_to(to)
{
  ...
  /*
  from->m_signal_item_has_updated.connect(
    boost::bind(
      &QtPvdbEdgeItem::OnItemUpdated,this));

  to->m_signal_item_has_updated.connect(
    boost::bind(
      &QtPvdbEdgeItem::OnItemUpdated,this));
  */
