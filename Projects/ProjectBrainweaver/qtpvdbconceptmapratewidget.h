...
struct QtPvdbConceptMapRateWidget : public QtPvdbConceptMapWidget
{
  ...
  boost::signals2::signal<void (boost::shared_ptr<ribi::pvdb::ConceptMap>)> m_signal_request_rate_concept_dialog;
...
private:
  ...
  const boost::shared_ptr<ribi::pvdb::ConceptMap> CreateSubConceptMap(QtPvdbNodeItem * const item);
